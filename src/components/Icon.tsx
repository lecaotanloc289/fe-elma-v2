...
const IconButton = ({
  ...
  <button
    type="button"
    onClick={onClick}
    className={`!bg-white cursor-pointer flex justify-center items-center border w-[44px] h-[44px] text-dark-lightest !border-gray-300 rounded-full ${className ?? ''}`}
  >
...
export { SocialIcon, IconButton, HomeIcon, DiscountIcon };
